...
document.querySelector(".mobile-footer .material-symbols-outlined:nth-child(1)").addEventListener("click", () => {
  console.log("home icon clicked");
  profilePage.style.display = "none";
  userContent.style.display = "block";
});
document.querySelector(".mobile-footer .material-symbols-outlined:nth-child(4)").addEventListener("click", () => {
...
document.querySelector(".mobile-footer .material-symbols-outlined:nth-child(6)").addEventListener("click", () => {
        ...
        imageRef.put(newPhoto)
            ...
            .then(downloadURL => {
                db.collection("posts").doc(id).update({
                    ...
                    getPostsFromFirebase(uid, displayName);
